...
def perform_equality_reduction(parsed_expr):
  ...
  # t(x) = u(x)
    ...
    inner_left = [opposite, new_variable1, ['in', 'lz', replace_subformula(parsed_prop[1], replaced, replacer)], parsed_expr[3], parsed_equality]
    remaining_variables = set(var_list).difference(set(used_variables))
    new_variable2 = remaining_variables.pop()
    used_variables.append(new_variable2)      
    inner_right = [opposite, new_variable2, ['in', 'lz', replace_subformula(parsed_prop[2], replaced, replacer)], parsed_expr[3], parsed_equality]
    middle_left = ['SUB1', inner_left, ['in', 'lz', parsed_prop[1]], parsed_expr[1], parsed_prop]
    middle_right = ['SUB0', inner_right, ['in', 'lz', parsed_prop[2]], parsed_expr[1], parsed_prop]
    outer_left = [parsed_expr[0], middle_left, ['in', 'lz', parsed_prop[2]], parsed_expr[3], parsed_equality]
    outer_right = [parsed_expr[0], middle_right, ['in', 'lz', parsed_prop[1]], parsed_expr[3], parsed_equality]
...
if __name__ == "__main__":
  ...
  proof_1_normal = run_test(proof_1)
  ...
  print(proof_2)
  proof_2_normal = run_test(proof_2)
  
  # Proof that <t, u> = <r, s> -> t = r
  proof_3 = '(\
        La. ( OUT(SUB1(IN(I0(EQ((Lb.b),(Lc.c)))) :\
        ( {lx | (lx = lt)} in {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lu))}))} ),\
        a : ( {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lu))}))} = {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ) ))\
        DE(d.OUT(SUB1(IN(EQ((Lf.f),(Lg.g))) :\
        ( lt in {lx | (lx = lt)} ),\
        d : ({lx | (lx = lt)} = {lx | (lx = lr)}) ) ),\
        e.SUB1(EQ((Lh.h),(Li.i)) : (lr = lr),\
        OUT(SUB0(IN(I0(EQ((Lj.j),(Lk.k)))) : ( lr in {lx | ((lx = lr) vee (lx = ls))} ),\
        e : ({lx | (lx = lt)} = {lx | ((lx = lr) vee (lx = ls))}) )) : (lr = lt) ) ) )\
        )'
  proof_3_normal = run_test(proof_3)
  
  ordered_pair_tu = '{lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lu))}))}'
  ordered_pair_rs = '{lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))}'
      
  # Proof that <t, u> = <r, s> \vdash (u = r) vee (u=s)
  proof_4 = '(\
        OUT(SUB1(IN(I1(EQ((Lb.b),(Lc.c)))) :\
        ( {lx | ((lx = lt) vee (lx = lu))} in {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lu))}))} ),\
        a : ( {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lu))}))} = {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ) ) )\
        DE(d.I0(OUT(SUB1(IN(I1(EQ((Lf.f),(Lg.g)))) :\
        ( lu in {lx | ((lx = lt) vee (lx = lu))} ),\
        d : ( {lx | ((lx = lt) vee (lx = lu))} = {lx | (lx = lr)} ) ) ) ),\
        e.OUT(SUB1(IN(I1(EQ((Lh.h),(Li.i)))) :\
        ( lu in {lx | ((lx = lt) vee (lx = lu))} ),\
        e : ( {lx | ((lx = lt) vee (lx = lu))} = {lx | ((lx = lr) vee (lx = ls))} ) ) ) )\
        )'  
  proof_4_normal = run_test(proof_4)
  
  # <t, u> = <r, s> \vdash t = r
  proof_5_lemma_lemma = '(\
      OUT(SUB1(IN(I0(EQ((Lb.b),(Lc.c)))) :\
      ( {lx | (lx = lt)} in {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lu))}))} ),\
      a : ( {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lu))}))} = {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ) ))\
      DE(d.OUT(SUB1(IN(EQ((Lf.f),(Lg.g))) :\
      ( lt in {lx | (lx = lt)} ),\
  ...
  proof_5_lemma_lemma_normal = run_test(proof_5_lemma_lemma)
  
  #Proof that (u = r) \vdash r = t
  proof_5_lemma_a = 'OUT(SUB0(IN(EQ((Lj.j),(Lk.k))) :\
          ( lr in {lx | ((lx = lr) vee (lx = ls))} ),\
          OUT(SUB0(IN(EQ((Ll.l),(Lm.m))) :\
          ( {lx | ((lx = lr) vee (lx = ls))} in {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ),\
          SUB0(SUB1(a :\
          ( {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lu))}))} = {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ),\
          SUB0(z : (lu = lr),' +\
          proof_5_lemma_lemma +\
          ': (lt = lr) ) : (lu = lt) ) :\
          ( {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lt))}))} = {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ),' +\
          proof_2 +\
          ': ( {lx | (lx = {lx | (lx = lt)})} = {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lt))}))} ) ) :\
          ( {lx | (lx = {lx | (lx = lt)})} = {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ) ) ) :\
          ( {lx | ((lx = lr) vee (lx = ls))} = {lx | (lx = lt)} ) ) )'
  proof_5_lemma_a_normal = run_test(proof_5_lemma_a)
  
  proof_5_lemma_b = 'OUT(SUB0(IN(EQ((Ln.n),(Lo.o))) :\
          ( ls in {lx | ((lx = lr) vee (lx = ls))} ),\
          OUT(SUB0(IN(EQ((Lp.p),(Lq.q))) :\
          ( {lx | ((lx = lr) vee (lx = ls))} in {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ),\
          SUB0(SUB1(a :\
          ( {lx | ((lx = {lx | (lx = lt)}) vee (lx = {lx | ((lx = lt) vee (lx = lu))}))} = {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ),\
          SUB0(z : (lu = lr),' +\
          ...
          ( {lx | (lx = {lx | (lx = lt)})} = {lx | ((lx = {lx | (lx = lr)}) vee (lx = {lx | ((lx = lr) vee (lx = ls))}))} ) ) ) :\
          ( {lx | ((lx = lr) vee (lx = ls))} = {lx | (lx = lt)} ) ) )'
  proof_5_lemma_b_normal = run_test(proof_5_lemma_b)  
  
  # Proof that (u = r) vee (u = s) \vdash u = s
  proof_5 = '(La. (' +\
        proof_4 +\
        'DE(y.y,\
        z.SUB0(z : (lu = lr), SUB0(' +\
  ...
  proof_5_normal = run_test(proof_5)
